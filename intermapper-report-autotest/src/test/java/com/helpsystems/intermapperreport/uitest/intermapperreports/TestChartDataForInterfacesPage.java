...
/**
 * class for testing all elements in the IMDC Reports/Chart Data For I page
 * 
 * @author Armen Torunyan
 * 
 */

public class TestChartDataForInterfacesPage extends IntermapperReportsBaseTest {
	@Override
	...
	public void validation() throws Exception {
		// Click Chart Data for Interfaces tab
		TimeUnit.MILLISECONDS.sleep(100);
		intermapperReportsValidator.clickOnChartDataForInterfacesTab();
